...
public class Game {
    ...
    // To check if the move available
    ...
    void makeMoveOrSelect(int i, int j) {
        // Deselect the cell if it is selected or the destination contains another ball already
    ...
    void makeMove(int x, int y) {
        ...
        // Removing the ball from the last position
